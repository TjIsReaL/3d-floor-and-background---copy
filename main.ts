...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.floorDark0, function (sprite, location) {
    tiles.setTileAt(tiles.getTileLocation(6, 3), sprites.dungeon.floorDark0)
})
function Summon_alien () {
    ...
    statusbar2.setLabel("Aien")
    statusbar2.positionDirection(CollisionDirection.Bottom)
    statusbar2.value = 50
}
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile8`, function (sprite, location) {
    if (Power == 1) {
        tiles.setTileAt(tiles.getTileLocation(6, 3), assets.tile`myTile10`)
        Power = 0
        tiles.setWallAt(tiles.getTileLocation(6, 2), false)
        tiles.setTileAt(tiles.getTileLocation(6, 2), sprites.dungeon.floorDark0)
        timer.after(5000, function () {
            game.showLongText("Uh oh. An alien has breached the base.", DialogLayout.Center)
...
let statusbar = statusbars.create(50, 4, StatusBarKind.Health)
statusbar.setColor(2, 15)
statusbar.value = 100
statusbar.positionDirection(CollisionDirection.Top)
statusbar.setLabel("HP")
statusbar.setOffsetPadding(2, 4)
Power = 0
game.showLongText("You have been abandoned by your crew and trapped on the moon base", DialogLayout.Full)
...
scene.setBackgroundImage(img`
    ...
    ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    `)
let Power_Core = sprites.create(img`
    ...
    f f f f f f f f f f f f f f f f 
    `, SpriteKind.Help)
tiles.placeOnTile(Power_Core, tiles.getTileLocation(1, 3))
